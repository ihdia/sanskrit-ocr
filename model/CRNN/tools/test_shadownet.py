...
def init_args():
    ...
    parser.add_argument('--filename', type=str, help='Test filename')
...
def test_shadownet(filename, weights_path, is_vis=False, is_recursive=True):
    """
...
if __name__ == '__main__':
    ...
    # test shadow net
    test_shadownet(args.filename, args.weights_path, args.is_recursive)
